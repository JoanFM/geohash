...
class GeoHashTest extends FlatSpec {
  	...
  	"A partial solutions list " should " have the same lenght as input list " in {
    ...
    "A partial solutions list " should " have one less element than the lenght of the input list if an invalid coordinate is introduced" in {
